...
module.exports = function(app) {
  ...
  app.get('/api/user/findByEmail', users.findByEmail);
  app.post('/api/user/changeInfo', users.changeInfo);
  app.post('/api/user/sendNewPwd', users.sendNewPwd);
  ...
  app.get('/api/report/lastest', report.workList);
  ...
  app.get('/api/article/getNews', article.getNews);
  app.get('/api/article/:id/show', article.queryByID);
  ...
  app.put("/api/manage/users/changeStatus", users.changeStatus);
